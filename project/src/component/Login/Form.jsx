  ...
  return (
    <div className="bg-white px-10 py-20 rounded-3xl border-2 border-gray-100">
      ...
      <div className="mt-8 flex flex-col gap-y-4">
        <button
          className={`active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl bg-violet-500 text-white text-lg font-bold ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
        ...
        <button
          ...
          disabled={loading} // Disable Google sign-in during loading
        >
          <svg
      ...
      <div className="mt-8 flex justify-center items-center">
        ...
        <button
          ...
          disabled={loading} // Disable sign-up button during loading
        >
          Sign up
        </button>
      </div>
